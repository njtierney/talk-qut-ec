...
```{r show-monnahan}
knitr::include_graphics("imgs/monnahan-2016.png")
```
...
.pull-right[
```{r tf-examples}
knitr::include_graphics("imgs/tf-examples.png")
```
...
```{r extendable}
knitr::include_graphics("imgs/greta-extendable.png")
```
...
knitr::include_graphics("imgs/greta-extendable-gp.png")
```
...
.pull-right[
```{r show-grete}
knitr::include_graphics("imgs/grete-hermann")
```
...
* put bits on what greta is here *
